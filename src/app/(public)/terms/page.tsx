...
export const metadata: Metadata = {
  title: 'Пользовательское соглашение — NEWSY',
  description: 'Условия использования платформы NEWSY. Права и обязанности пользователей и организаторов.',
};
  ...
  return (
    <main style={{ maxWidth: 800, margin: '0 auto', padding: '40px 24px', fontFamily: 'system-ui, sans-serif', lineHeight: 1.7, color: '#1a1a1a' }}>
      ...
      <section>
        ...
        <p>
          Настоящее Пользовательское соглашение регулирует отношения между NEWSY (далее — «Платформа»)
